    ...
    class Validation {
        ...
        public function min($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) < $length){
                    $this->errors[] = 'La valeur du champ '.$this->name.' est inférieur à la valeur minimale de '.$length; //.$length affiche le min que tu a mis
                }
        ...
        public function max($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) > $length){
                    $this->errors[] = 'La valeur du champ '.$this->name.' est supérieur à la valeur maximale de '.$length;
                }
